...
class CmdVelCheck : public rclcpp::Node{
public:
    CmdVelCheck() : Node("cmd_vel_check"){
        // subscription
        cmd_vel_subscription_ = this -> create_subscription<geometry_msgs::msg::Twist>(
            "/cmd_vel", 10, std::bind(&CmdVelCheck::cmd_vel_cb, this, _1));
...
int main(int argc, char **argv) {
    ...
    rclcpp::spin(std::make_shared<CmdVelCheck>());
    rclcpp::shutdown();
    return 0;
}
